...
<Table>
  <thead>
    <tr><th>구성</th><th>보유 블록</th></tr>
  </thead>
  <tbody>
    <tr><td>클라이언트 → NameNode(메타데이터 관리)</td><td>-</td></tr>
    <tr><td>DataNode 1</td><td>블록 A, B</td></tr>
    <tr><td>DataNode 2</td><td>블록 B, C</td></tr>
    <tr><td>DataNode 3</td><td>블록 A, C</td></tr>
  </tbody>
</Table>
