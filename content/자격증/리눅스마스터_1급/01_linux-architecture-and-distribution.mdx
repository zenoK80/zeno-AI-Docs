...
<Table>
  <thead>
    <tr><th>계층(위→아래)</th><th>구성 요소</th></tr>
  </thead>
  <tbody>
    <tr><td>응용프로그램</td><td>웹 브라우저, 편집기, 서버 데몬</td></tr>
    <tr><td>셸</td><td>bash / zsh / sh / ksh / csh</td></tr>
    <tr><td>리눅스 커널</td><td>프로세스 · 메모리 · 파일시스템 · 장치 드라이버 · 네트워크</td></tr>
    <tr><td>하드웨어</td><td>CPU · 메모리 · 디스크 · NIC</td></tr>
  </tbody>
</Table>
