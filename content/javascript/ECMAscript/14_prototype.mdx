...
<Table>
  <thead>
    <tr><th>단계</th><th>객체</th></tr>
  </thead>
  <tbody>
    <tr><td>1</td><td>`dog`</td></tr>
    <tr><td>2</td><td>`animal`(dog의 프로토타입)</td></tr>
    <tr><td>3</td><td>`Object.prototype`(animal의 프로토타입)</td></tr>
    <tr><td>4</td><td>`null`(체인의 끝)</td></tr>
  </tbody>
</Table>
