...
<Table>
  <thead>
    <tr><th>계층</th><th>태그</th><th>역할</th></tr>
  </thead>
  <tbody>
    <tr><td>최상위</td><td>`html`</td><td>문서 전체</td></tr>
    <tr><td>└ 자식</td><td>`head`</td><td>안 보이는 정보(제목, 메타데이터)</td></tr>
    <tr><td>&nbsp;&nbsp;&nbsp;└ 손자</td><td>`title`</td><td>페이지 제목</td></tr>
    <tr><td>└ 자식</td><td>`body`</td><td>화면에 보이는 내용</td></tr>
    <tr><td>&nbsp;&nbsp;&nbsp;└ 손자</td><td>`h1`, `p`, `button`</td><td>제목, 문단, 버튼</td></tr>
  </tbody>
</Table>
