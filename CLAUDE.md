...
- 독자는 프로그래밍 초보다. 용어를 처음 쓸 때 짧게 정의하고, 작은 코드 예제를 통해 바로 확인할 수 있게 쓴다.
...
- 내용: 방금 배운 핵심 개념을 확인하는 **퀴즈**(문답 + `<Collapse>`로 정답 숨기기)와, 손으로 직접 해보는 **짧은 실습**을 함께 담는다. 개념 위주 편은 퀴즈 비중을, 실습 위주 편(환경 설정, Canvas 등)은 실습 비중을 높인다
